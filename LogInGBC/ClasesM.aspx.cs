...
public partial class ClasesM : System.Web.UI.Page
{
    ...
    protected void cargarclase()
    {
        ...
        cmd.Parameters.AddWithValue("_Clave", ddlclasesm.SelectedValue);
    ...
    {
        string procedure = "spCargarMaterialesMaestro", usuario = Session["uxr"].ToString();
        string conexion = ConfigurationManager.ConnectionStrings["conBD"].ConnectionString;
        MySqlConnection conn = new MySqlConnection(conexion);
        conn.Open();
        ...
        DataTable dt = new DataTable();
        adaptador.Fill(dt);
        ddlclasesm.DataValueField = "claveNivel";
        ddlclasesm.DataTextField = "nombre";
        ddlclasesm.DataSource = dt;
        ddlclasesm.DataBind();
        conn.Close();
    }
