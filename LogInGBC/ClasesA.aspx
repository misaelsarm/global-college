<%@ Page Title="" Language="C#" MasterPageFile="~/AlumnosMaster.master" AutoEventWireup="true" CodeFile="ClasesA.aspx.cs" Inherits="ClasesA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="container">
                ...
                <nav id="menu-principal" class="collapse">
                    <ul>
                        ...
                        <li><a href="EssentialSoundsa.aspx" data-scroll>Essential Sounds ©</a></li>
    ...
    <section class="MaterialesA m-x-auto" style="min-height: 63vh">
        <div class="row col-md-12 flex-items-md-middle">
            <div class="row col-md-12 text-md-center m-x-auto flex-items-xs-center m-b-3">
                <div class="col-md-4 text-md-center text-xs-center">
                    ...
                    <asp:DropDownList ID="ddlclasesa" runat="server" CssClass="btn btn-secondary btn-block" Height="38px">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row col-md-12 text-md-center m-x-auto flex-items-xs-center m-b-3">
