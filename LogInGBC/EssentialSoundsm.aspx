<%@ Page Title="" Language="C#" MasterPageFile="~/Maestros.master" AutoEventWireup="true" CodeFile="EssentialSoundsm.aspx.cs" Inherits="EssentialSoundsm" %>
        ...
        <header class="encabezado navbar-fixed-top" role="banner" id="encabezado">
            <div class="container">
                ...
                <nav id="menu-principal" class="collapse">
                    <ul>
                        <li><a href="ClasesM.aspx" data-scroll>Clases</a></li>
                        <li class="active"><a href="#" data-scroll>Essential Sounds ©</a></li>
